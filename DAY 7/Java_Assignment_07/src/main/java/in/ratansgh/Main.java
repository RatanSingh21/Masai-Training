...
import in.ratansgh.models.restaurant.*;
import in.ratansgh.models.user.Customer;
import in.ratansgh.models.user.RestaurantOwner;
import in.ratansgh.models.user.SystemAdmin;
import in.ratansgh.services.repository.DataStore;
import in.ratansgh.services.strategy.NoDiscount;
import in.ratansgh.services.strategy.PercentageDiscount;
import in.ratansgh.util.InputUtil;
            ...
            private static void handleCustomer() {
                ...
                while (true) {
                    ...
                    r.findDish(did).ifPresentOrElse(d -> {
                        ...
                        Order o = new Order(List.of(), strategy);
